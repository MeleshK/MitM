...
mitmdump --anticomp --anticache --set block_global=false --set flow_detail=3 --mode transparent --showhost --save-stream-file "/project/mitmproxy_$now.cap" --set stream_large_bodies=5m --ssl-insecure --verbose &
